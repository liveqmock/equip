...
<div style="padding-left:10px; margin-bottom:8px;">您的意见会让系统做得更好<br /></div>
<form id="bug_form" method="post" enctype="application/x-www-form-urlencoded">
<textarea name="bug_c" id="bug_c" cols="59" rows="5" style=" border:solid 3px #E2E2E2;line-height:10px; padding:5px;"></textarea>
<br />
